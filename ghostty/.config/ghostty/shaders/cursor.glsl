...
const vec4 TRAIL_COLOR = vec4(0.259, 0.259, 0.259, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.259, 0.259, 0.259, 1.0);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    float lineLength = distance(centerCC, centerCP) * 0.8;
    //
