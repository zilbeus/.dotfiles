...
vim.keymap.set('n', '<leader>gh', "<cmd>DiffviewFileHistory<cr>",
    { desc = 'Open [G]it File [H]istory view' })
vim.keymap.set('n', '<leader>gc', "<cmd>DiffviewOpen<cr>",
    { desc = 'Open [G]it [C]hanges view' })
vim.keymap.set('n', '<leader>gk', "<cmd>DiffviewClose<cr>",
    { desc = '[K]ill [G]it view' })
